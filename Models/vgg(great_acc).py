...
if __name__ == "__main__":
    ...
    train_dataset = datasets.ImageFolder('Datasets/Train', transform=transform_aug)
    validate_dataset = datasets.ImageFolder('Datasets/Validate', transform=transform_format)
    test_dataset = datasets.ImageFolder('Datasets/Test', transform=transform_format)

    train_loader = DataLoader(train_dataset, batch_size=batch, shuffle=True)
    val_loader = DataLoader(validate_dataset, batch_size=batch, shuffle=False)
    ...
    class EarlyStopping:
        def __init__(self, patience=10, delta=0.001):
            ...
            self.best_model_path = Path('Models/Saved_Models/VGG19') / 'best_vgg.pth'
